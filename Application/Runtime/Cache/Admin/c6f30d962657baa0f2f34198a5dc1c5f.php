        ...
        <div class="am-g">
            <div class="am-u-sm-12">
                ...
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>全部员工</small></div>

                    <a href="?s=/Admin/Index/allStaffOutExcel"  class="am-btn am-btn-primary am-round am-fr"
                       style="margin-top: 10px;">导出到Excel
                    </a>
                </div>

                <section class="am-panel am-panel-default">
                    <header class="am-panel-hd">
                        <h3 class="am-panel-title">从Excel导入</h3>
                    </header>
                    <div class="am-panel-bd" style="height:100px;">
                        <div class="am-g am-u-sm-6">
                            <form method="post" action="/aliyunHost/yearMeeting/?s=/Admin/Index/upload" enctype="multipart/form-data">
                                <input type="file" name="excelData" />
                                <button type="submit" class="am-btn am-btn-primary am-round am-fl" style="margin-top: 10px;">提交</button>
                            </form>
                        </div>
                ...
                <table class="am-table am-table-bd am-table-striped admin-content-table">
                    <thead>
                    <tr>
                        <th>编号</th> <th>姓名</th><th>公司</th><th>身份</th><th>已签到</th><th>奖项</th><th>管理</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php if(is_array($alllist)): $i = 0; $__LIST__ = $alllist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($vol["id"]); ?></td>
                            <td><?php echo ($vol["real_name"]); ?></td>
                            <td><?php echo ($vol["department"]); ?></td>
                            <td><?php echo ($vol["status"]); ?></td>
                            <td><?php echo ($vol["signed"]); ?></td>
                            <td><?php echo ($vol["level"]); ?></td>
                            ...
                            <td>
                                <div class="am-dropdown" data-am-dropdown>
                                    ...
                                    <ul class="am-dropdown-content">
                                        <li><a href="/aliyunHost/yearMeeting?s=/Admin/Index/editAllStaff&id=<?php echo ($vol["id"]); ?>">编辑</a></li>
                                        <li><a href="/aliyunHost/yearMeeting?s=/Admin/Index/deleteFromAllStaff&id=<?php echo ($vol["id"]); ?>">删除</a></li>
                                    </ul>
                                </div>
                            </td>
