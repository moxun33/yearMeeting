...
<div class="am-cf admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">奖品管理</strong> / <small>编辑</small></div>
        </div>

        <div class="am-g">

                <div class="am-u-sm-12">
                    <form method="post" class="am-form" action="/aliyunHost/yearMeeting/?s=/Admin/Index/updateAward">
                        <div class="am-form-group">
                            <label>等级</label>
                            <select id="doc-select-1" style="width:100px;" name="awardLevel" value="<?php echo ($editAward["award_level"]); ?>">
                            <option value="<?php echo ($editAward["award_level"]); ?>" ><?php echo ($editAward["award_level"]); ?></option>
                            ...
                            <input style="display: none;" type="number"  name="id" value="<?php echo ($editAward["id"]); ?>" >

                            <br>


                            <label>奖品名称</label>
                            <input style="width:300px;" type="text" class="goodsName" name="goodsName" value="<?php echo ($editAward["goods_name"]); ?>" placeholder="每个等级的奖品名称">
                            <br>
                            <label>奖品数量</label>
                            <input style="width:500px;" type="number" class="goodsNumber"  name="goodsNumber" value="<?php echo ($editAward["winner_number"]); ?>" placeholder="每个等级的奖品数量">

                        </div>

                        <input type="submit" name="" value="提交" class="am-btn am-btn-success am-btn-sm am-fl">&nbsp
