...
<!-- sidebar end -->
    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>概览</small></div>
        </div>

        <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">

                       <li><a href="#" class="am-text-success"><span class="am-icon-btn am-icon-file-text"></span><br/>新增签到<br/><?php echo ($now_sign_number); ?></a></li>
                   <!-- <li><a href="#" class="am-text-warning"><span class="am-icon-btn am-icon-briefcase"></span><br/>已经签到<br/>308</a></li>
                    -->
                   <li><a href="#" class="am-text-secondary"><span class="am-icon-btn am-icon-user-md"></span><br/>已经签到<br/><?php echo ($total_sign_number); ?></a></li>
                    <li><a href="#" class="am-text-danger" ><span class="am-icon-btn am-icon-bookmark" ></span><br/>会议人数<br/><?php echo ($total_meeting_number); ?></a></li>


            <li><a href="#" class="am-text-success"><span class="am-icon-btn am-icon-cny"></span><br/>奖品价值<br/>50000
            </a></li>
        ...
        <div class="am-g">
            <div class="am-u-sm-12">
                ...
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>所有签到用户
                    </small></div>
                   <a href="/aliyunHost/lottery/?s=/Admin/Index/signUserOut">
                        <button type="button" class="am-btn am-btn-primary am-round am-fr">导出Excel</button>
                    </a>
                    <a href="/aliyunHost/lottery/?s=/Admin/Index/addUser">
                        <button type="button" class="am-btn am-btn-success am-round am-fr">添加签到用户</button>
                    </a>
                </div>
                <table class="am-table am-table-bd am-table-striped admin-content-table">
                    <thead>
                    <tr>
                        <th>编号</th> <th>姓名</th><th>手机号</th><th>身份</th><th>头像</th><th>签到时间</th><th>管理</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <div class="am-dropdown" data-am-dropdown>
                                    ...
                                    <ul class="am-dropdown-content">
                                        <li><a href="/aliyunHost/lottery?s=/Admin/Index/editSignUser&id=<?php echo ($vol["id"]); ?>">编辑</a></li>
                                        <li><a href="/aliyunHost/lottery?s=/Admin/Index/deleteUser&id=<?php echo ($vol["id"]); ?>">删除</a></li>
                                    </ul>
                                </div>
                            </td>
