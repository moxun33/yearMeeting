    ...
    <div class="admin-content">
        ...
        <div class="am-g am-g-fixed">
            <div class="am-u-sm-12  am-u-sm-centered">
                ...
                <form class="am-form" method="post" action="/aliyunHost/yearMeeting/?s=/Admin/Index/checkEditSignUser" enctype="multipart/form-data" >
                    <fieldset>
                        ...
                        <div class="am-form-group">
                            ...
                            <select id="status-select" style="width:100px;" name="status" value="<?php echo ($status); ?>">
                                ...
                                <?php if($status == '未知身份' ): ?><option value="员工">员工</option>
                                    <option value="嘉宾">嘉宾</option><?php endif; ?>
