...
<title>抽奖</title>
<link href='http://fonts.awesome.com/css?family=Roboto' rel='stylesheet' type='text/css'>
<link rel="stylesheet" href="./Public/LotteryLib/youxiaLotteryDemo/css/screen.css">
</head>
<body>
	<div id="wrapper">
		<div id="loader"> 
			...
			<div class="board">
				...
				<div class="first">
					...
					<div class="list">
						...
						<ul class="win">
							<li>
								<div class="avatar"><img width="34" src="img/blank.gif"/></div>
								<div class="num">***********</div>
								<div class="name"></div>
	...
	<script type="text/javascript" src="./Public/LotteryLib/youxiaLotteryDemo/js/jquery-2.0.3.min.js"></script>
	<script type="text/javascript" src="./Public/LotteryLib/youxiaLotteryDemo/js/dataSource.js"></script>
