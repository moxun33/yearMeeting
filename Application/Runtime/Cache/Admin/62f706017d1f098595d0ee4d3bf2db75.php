    ...
    <div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
        <div class="am-offcanvas-bar admin-offcanvas-bar">
            <ul class="am-list admin-sidebar-list">
                ...
                <li><a href="/aliyunHost/yearMeeting?s=/Admin/Index/photoWall/"><span class="am-icon-refresh am-icon-cube"></span> 照片墙</a></li>
                ...
                <li><a href="/aliyunHost/yearMeeting?s=/Admin/Index/notHereStaff"><span class="am-icon-user-times "></span> 未到人员</a></li>
                <li><a href="/aliyunHost/yearMeeting?s=/Admin/Index/setPage"><span class="am-icon-wrench"></span> 系统设置</a></li>
                <li><a href="/aliyunHost/yearMeeting?s=/Admin/Index/addPage"><span class="am-icon-plus "></span> 添加管理员</a></li>
                <li><a href="/aliyunHost/yearMeeting?s=/Admin/Index/lotteryPrint"><span class="am-icon-yelp "></span> 中奖名单打印</a></li>
        ...
        <div class="am-g">
            <div class="am-u-sm-12">
                ...
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>未到人员</small></div>

                </div>
                <table class="am-table am-table-bd am-table-striped admin-content-table">
                    <thead>
                    <tr>
                        <th>编号</th><th>姓名</th><th>手机号</th><th>身份</th><th>管理</th>
                    </tr>
                    </thead>
                    <tbody>
                            ...
                            <td>
                                <div class="am-dropdown" data-am-dropdown>
                                    ...
                                    <ul class="am-dropdown-content">
                                        ...
                                        <li><a href="/aliyunHost/yearMeeting?s=/Admin/Index/deleteNotHereStaff&id=<?php echo ($vol["id"]); ?>">删除</a></li>
                                    </ul>
                                </div>
                            </td>
