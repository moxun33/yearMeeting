...
<div class="get">
    <?php if(!empty($nowGet)): ?><div class="am-g">
                 <div class="am-u-lg-12">
                      <h1 class="get-title">本次取款金额:<?php echo ($nowGet); ?></h1>
    ...
    <div class="am-g">
        ...
        <div class="am-u-sm-3" style="margin-left: 38%">
            <form method="post" class="am-form" action="/aliyunHost/bank/?s=/Home/Index/get_money">
                <input type="text" name="moneyGet" class="" id="doc-ipt-email-1" placeholder="输入人民币金额,(单位:元)">
